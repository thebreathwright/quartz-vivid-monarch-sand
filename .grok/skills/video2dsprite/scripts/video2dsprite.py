#!/usr/bin/env python3
"""Postprocess Grok imagine_video clips into dense 2D sprites.
...
This skill is designed for Grok Build (imagine_image + imagine_video).
...
def cmd_process(args: argparse.Namespace) -> int:
    ...
    meta = {
        "skill": "video2dsprite",
        "platform": "Grok Build (imagine_video required for generation step)",
        "name": args.name,
